...
public class Snmp4jFirstDemo {
    ...
    public void sendMessage(Boolean syn, final Boolean bro, PDU pdu, String addr)
        ...
        if (version == SnmpConstants.version3) {
            // 添加用户
            snmp.getUSM().addUser(new OctetString("MD5DES"),new UsmUser(new OctetString("MD5DES"),
            		AuthMD5.ID,new OctetString("MD5DESUserAuthPassword"),PrivDES.ID, 
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            manager.sendMessage(false, true, pdu, "udp:202.117.15.163/161");//192.168.1.233 WinServer2008服务器
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
